...
main_parser.set_defaults(func=handle_name)
...
parser_del_secret = subparsers.add_parser('del', help='Delete a secret')
...
def main():
    ...
    client = CustodiaSimpleClient(args.server)
    if args.cafile:
        client.set_ca_cert(args.cafile)
    if args.certfile:
        client.set_client_cert(args.certfile, args.keyfile)
